...
def preprocess(inputdir,
    ...
    print("\t* Reading data...")
    data = preprocessor.read_test_data(os.path.join(inputdir, dev_file))
...
if __name__ == "__main__":
    default_config = "./config/preprocessing/preprocessing.json"
    ...
    preprocess(os.path.normpath(config["data_dir"]),
