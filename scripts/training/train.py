...
if __name__ == "__main__":
    default_config = "./config/training/training.json"
    ...
    main(os.path.normpath(config["train_data"]),
         ...
         config["hidden_size"], config["dropout"], config["num_classes"],
         config["epochs"], config["batch_size"], config["lr"],
         config["patience"], config["max_gradient_norm"], args.checkpoint)
